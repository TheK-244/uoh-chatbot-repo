...
# ينشئ اتصالًا بقاعدة البيانات لعملية المزامنة.
def get_connection():
...
# يبني النص النهائي لكل عنصر قبل تحويله إلى embedding.
...
# يرسل النص إلى OpenAI ويرجع embedding الخاص به.
...
# يزامن كل عناصر قاعدة البيانات مع جدول ai_documents.
def sync_all_items():
    conn = get_connection()
